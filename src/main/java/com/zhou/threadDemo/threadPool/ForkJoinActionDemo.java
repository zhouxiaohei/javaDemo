...
public class ForkJoinActionDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        log.info("1.从DB1中读取数据并存放到List中,共计读取了" + count + "条数据.");

        //DB2的数据量
        log.info("2.开始时，DB2中的数据量：" + DB2.size());

        log.info("3.通过ForkJoin框架进行子任务划分，并发送数据");
        //定义一个ForkJoin线程池
        ...
        //查询最终传输的数据量
        log.info("4.结束时，DB2中的数据量：" + DB2.size());
        //查询其中一条数据
        log.info("5.查询其中一条数据：" + DB2.peek());
    }
}
